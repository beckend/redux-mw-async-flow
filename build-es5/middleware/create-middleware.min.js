var tslib_1=require("tslib");var Observable_1=require("rxjs/Observable");exports.Observable=Observable_1.Observable;var Subject_1=require("rxjs/Subject");exports.Subject=Subject_1.Subject;var async_types_1=require("../async-types");var promise_factory_1=require("../promise-factory");var request_store_1=require("../request-store");var date_1=require("./date");var default_options_1=require("./default-options");var middleware_observers_1=require("./middleware-observers");var merge=require("lodash.merge");
...
REQUEST,PENDING)},addedActionMetaData);dispatchAsyncFlow(pendingAction);var newAction=merge({},actionClone,addedActionMetaData);dispatchAsyncFlow(newAction);return}else if(actionType.endsWith(FULFILLED))handleEndAction(FULFILLED,true);else if(actionType.endsWith(REJECTED))handleEndAction(REJECTED,false);else if(actionType.endsWith(ABORTED))handleEndAction(ABORTED,false);else dispatchNormal();var _b,_c}}};return{middleware:middleware,observers:{after:{obsOnAll:mwObservers.after.obsOnAll,obsOnEnd:mwObservers.after.obsOnEnd,
